...
public class UserImpDao implements UserInterfaceDao{
	...
	public boolean userRegister(User us) {
		boolean f=false;
		try {
			String usinsert="insert into user(name,phone,email,password) values(?,?,?,?)";
			PreparedStatement ps=conn.prepareStatement(usinsert);
